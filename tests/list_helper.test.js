...
describe('favorite blog', () => {
  test('when list has multiple blogs find favorite', () => {
...
describe('most likes all together on author', () => {
  test('when list has multiple blogs find author with most likes', () => {
